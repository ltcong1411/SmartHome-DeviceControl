...
char* air = "{\"deviceType\":\"LightingControl\",\"deviceCode\": \"air\",\"numberOfPorts\": 1,\"lights\": [{\"portId\": 1, \"dimmable\": true, \"typeOfLight\": \"Air\"}]}";
String air_id = "";
...
//  Serial.print("Message: ");
 ...
 if((String)topic == "authenticate/air"){
    ...
    if(light=='1'){
      ...
      switch(coValue){
        case 17 :
          Serial.println("17");
          irsend.sendRaw(ON17, 295, 38);
          break;
        case 18 :
          Serial.println("18");
          irsend.sendRaw(ON18, 295, 38);
          break;
        case 0 :
          Serial.println("OFF");
          irsend.sendRaw(OFF, 295, 38);
          break;
        case 19 :
          Serial.println("19");
          irsend.sendRaw(ON19, 295, 38);
          break;
        case 20 :
          Serial.print("20");
          irsend.sendRaw(ON20, 295, 38);
          break;
        case 21 :
          Serial.print("21");
          irsend.sendRaw(ON21, 295, 38);
          break;
        case 22 :
          Serial.println("22");
          irsend.sendRaw(ON22, 295, 38);
          break;
        case 23 :
          Serial.println("23");
          irsend.sendRaw(ON23, 295, 38);
          break;
        case 24 :
          Serial.println("24");
          irsend.sendRaw(ON24, 295, 38);
          break;
        case 25 :
          Serial.print("25");
          irsend.sendRaw(ON25, 295, 38);
          break;
        case 26 :
          Serial.print("26");
          irsend.sendRaw(ON26, 295, 38);
          break;
        case 27 :
          Serial.println("27");
          irsend.sendRaw(ON27, 295, 38);
          break;
        case 28 :
          Serial.println("28");
          irsend.sendRaw(ON28, 295, 38);
          break;
        case 29 :
          Serial.print("29");
          irsend.sendRaw(ON29, 295, 38);
          break;
        case 30 :
          Serial.print("30");
          irsend.sendRaw(ON30, 295, 38);
          break;
      }
    }
  }
...
void checkMqttConnection() {
  ...
  if (!client.connected()) {
    ...
    if (client.connect("air", "lwt", 0, false, "rgb")) {
      ...
      delay(10);
      client.subscribe("authenticate/air");
...
void readAirValue(){
  ...
  delay(100);
  int port = 1;
  String topic = "devices/lighting-control/" + air_id + "/" + port;
  char msg[10];
  sprintf(msg, "%d",  aValue);
