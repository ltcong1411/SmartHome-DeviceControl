...
const char* device = "{\"deviceType\":\"LightingControl\",\"deviceCode\": \"lt04\",\"numberOfPorts\": 4, \"lights\": [{\"portId\": 1, \"dimmable\": true, \"typeOfLight\": \"Bulb\"},{\"portId\": 2, \"dimmable\":  false},{\"portId\": 3, \"dimmable\":  false}]}";
String device_id = "";
