...
char* rgb = "{\"deviceType\":\"LightingControl\",\"deviceCode\": \"rgb4\",\"numberOfPorts\": 1, \"lights\": [{\"portId\": 1, \"dimmable\": false, \"typeOfLight\": \"RGB\"}]}";
String rgb_id = "";

char* pir = "{\"deviceType\":\"SensorModule\",\"deviceCode\": \"pir4\",\"sensors\": [{\"name\": \"PIR4\", \"_type\": \"Pir\", \"value\": 0}]}";
String pir_id = "";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  } else  if ((String)topic == "authenticate/rgb4") {
  ...
  } else if ((String)topic == "authenticate/pir4") {
    timer.stop(authenticate_timer);
    pir_id = rmsg;
  ...
  void checkMqttConnection() {
    ...
    if (!client.connected()) {
      ...
      if (client.connect("rgb3", "lwt", 0, false, "rgb3")) {
        ...
        delay(10);
        client.subscribe("authenticate/rgb4");
        client.subscribe("authenticate/pir4");
  ...
  void readPirSensorValue() {
    ...
    if (eValue != eValue_previous) {
      ...
      sprintf(pir, "{\"deviceType\":\"SensorModule\",\"deviceCode\": \"pir4\",\"sensors\": [{\"name\": \"PIR4\", \"_type\": \"Pir\", \"value\": %d}]}",  eValue);
